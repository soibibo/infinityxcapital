    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
      ...
      <form wire:submit="submit" class="space-y-5">
        ...
        <button type="submit" wire:loading.attr="disabled"
          class="w-full bg-red-600 hover:bg-red-700 disabled:opacity-70 disabled:cursor-not-allowed text-white font-black py-4 rounded-xl transition-all duration-300 text-lg flex items-center justify-center gap-2 shadow-lg shadow-red-200 hover:shadow-xl">
          <span wire:loading.remove wire:target="submit">🚗 Order {{ $selectedCar['name'] }} Now →</span>
